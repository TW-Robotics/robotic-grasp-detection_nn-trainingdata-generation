...
class DopeNetwork(nn.Module):
	def __init__(
		...
		if pretrained is False:
			print("Training Network without pretrained on imagenet.")
		else:
			print("Training Network pretrained on imagenet.")
		vgg_full = models.vgg19(pretrained=pretrained).features     #Downloading: "https://download.pytorch.org/models/vgg19-dcbb9e9d.pth" to /home/mluser/.torch/models/vgg19-dcbb9e9d.pth
